...
postprocess_inputs = {
    'class_net/class-predict/BiasAdd':   tf.placeholder(dtype=tf.float32, shape=[1, 64, 64, 810]),
    'class_net/class-predict_1/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 32, 32, 810]),
    'class_net/class-predict_2/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 16, 16, 810]),
    'class_net/class-predict_3/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 8, 8, 810]),
    'class_net/class-predict_4/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 4, 4, 810]),
    'box_net/box-predict/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 64, 64, 36]),
    'box_net/box-predict_1/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 32, 32, 36]),
    'box_net/box-predict_2/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 16, 16, 36]),
    'box_net/box-predict_3/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 8, 8, 36]),
    'box_net/box-predict_4/BiasAdd': tf.placeholder(dtype=tf.float32, shape=[1, 4, 4, 36]),
}

postproc_neural_network_path = os.path.dirname(os.path.realpath(__file__)) + "/efficientdet-d0.post-process.pb"
with tf.gfile.Open(postproc_neural_network_path, 'rb') as graph_def_file:
